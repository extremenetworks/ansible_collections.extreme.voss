...
from ansible_collections.extreme.voss.tests.unit.compat.mock import patch
from ansible_collections.extreme.voss.tests.unit.modules.utils import set_module_args
from ansible_collections.extreme.voss.plugins.modules import voss_command
...
class TestVossCommandModule(TestVossModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.extreme.voss.plugins.modules.voss_command.run_commands')
