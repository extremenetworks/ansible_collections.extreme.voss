...
from ansible_collections.extreme.voss.plugins.modules import voss_facts
...
class TestVossFactsModule(TestVossModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.extreme.voss.plugins.modules.voss_facts.run_commands')
